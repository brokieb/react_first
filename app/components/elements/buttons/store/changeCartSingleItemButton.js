...
export default function changeCartSingleItemButton({ mode,id }) {
	...
	function handleChangeCartItem() {
        console.log(mode,id)
        axiosInstance.put('/api/cart/putChangeCartItems',{ 
            mode: mode,
            id:id
        }).then((item) => {
...
switch(mode){
    case 'minus':
        return (
       	<Button size="sm" variant="outline-warning" onClick={handleChangeCartItem}>
							<FontAwesomeIcon icon={faMinusCircle} />
						</Button>
        )
    case 'plus':
        return (
            <Button size="sm" variant="outline-success" onClick={handleChangeCartItem}>
                                <FontAwesomeIcon icon={faPlusCircle} />
                            </Button>
        );
    case 'remove':
        return (
           	<Button size="sm" variant="outline-danger" onClick={handleChangeCartItem}>
