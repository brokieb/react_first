					...
					<Form onSubmit={handleSubmit}>
						<Modal.Body className="pt-0">
							<Form.Group>
								...
								/>
								<Form.Control.Feedback type="invalid">{errors.discountCode}</Form.Control.Feedback>
							</Form.Group>
							<Form.Group>
							...
							<Form.Group>
								...
								<Form.Control.Feedback type="invalid">{errors.discontType}</Form.Control.Feedback>
							</Form.Group>
							<Form.Group>
