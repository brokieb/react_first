...
export default function CredentialsUserSpecialActionForm({ sendEmail, moveUsers, id, cb }) {
				...
				>
					{moveUsers ? (
						<Form.Group>
							...
							<Form.Control.Feedback type="invalid">{errors.newCredId}</Form.Control.Feedback>
						</Form.Group>
					) : (
						<></>
					)}
